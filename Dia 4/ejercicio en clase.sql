...
-- cambiar la columna de una tabla
/*
alter table full_order_info rename column stock_min to stockmin;

alter table full_order_info modify column stockmin
alter table full_order_info update column
*/
...
select first_name, sum(stock_price),name from full_order_info group by 1,3;


select sum(stock_price * stock) as amoun_stock , name from full_order_info group by name;
